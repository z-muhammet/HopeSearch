...
class MongoDbContext:
    ...
    def ensure_indexes(self):
        self.db["processed_sites_seo"].create_index("url", unique=True)
        self.db["processed_sites_seo_links"].create_index("url", unique=True)
        self.db["unprocessable_sites"].create_index("url", unique=True)
